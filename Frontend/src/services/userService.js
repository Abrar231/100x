...
export const getProfile = async (username) => {
    try {
        const response = await fetch(`${apiUrl}/api/profile/username/${username}`);
...
export const getProfileById = async () => {
    try {
        const response = await fetch(`${apiUrl}/api/profile/profileById`);
...
export const searchUser = async (query) => {
    try {
        const response = await fetch(`${apiUrl}/api/profile/search?q=${query}`);
...
export const isEmailAvailable = async (email) => {
    const response = await fetch(`${apiUrl}/api/emailAvailable?email=${email}`)
    return await response.json();
}