...
export const getProfileById = async () => {
    try {
        const response = await fetch(`/api/profile/profileById`);
...
export const followUser = async (user_id) => {
    try {
        const followed = await fetch(`/api/profile/follow`, {
            method: 'POST',
            headers: {
                "Content-Type": "application/json"
            },
...
export const unfollowUser = async (user_id) => {
    try {
        const unfollowed = await fetch(`/api/profile/unfollow`, {
            method: 'DELETE',
            headers: {
                "Content-Type": "application/json"
            },
...
export const isEmailAvailable = async (email) => {
    const response = await fetch(`/api/emailAvailable?email=${email}`)
    return await response.json();
}